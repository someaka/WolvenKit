...
namespace WolvenKit.Functionality.Layout.inkWidgets
{
    public class inkControl : UIElement
    {
        ...
        public static HorizontalAlignment ToHorizontalAlignment(Enums.inkEHorizontalAlign hAlign)
        {
            switch (hAlign)
            {
        ...
        public static VerticalAlignment ToVerticalAlignment(Enums.inkEVerticalAlign hAlign)
        {
            switch (hAlign)
            {
