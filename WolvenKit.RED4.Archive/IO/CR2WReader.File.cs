...
public partial class CR2WReader
{
    ...
    static CR2WReader()
    {
        s_bufferReaders.Add("appearanceAppearanceDefinition.compiledData", typeof(PackageReader));
        s_bufferReaders.Add("entEntityTemplate.compiledData", typeof(PackageReader));
        s_bufferReaders.Add("inkWidgetLibraryItem.packageData", typeof(PackageReader));
        s_bufferReaders.Add("entEntityInstanceData.buffer", typeof(PackageReader));
        s_bufferReaders.Add("gamePersistentStateDataResource.buffer", typeof(PackageReader));
        ...
        s_bufferReaders.Add("worldSharedDataBuffer.buffer", typeof(WorldTransformsReader));
        s_bufferReaders.Add("worldStreamingSector.transforms", typeof(StreamingSectorTransformReader));
    ...
    public EFileReadErrorCodes ReadFileInfo(out CR2WFileInfo info)
    {
        ...
        if (result.FileHeader.version is < 163 or > 195)
        {
            info = null;
